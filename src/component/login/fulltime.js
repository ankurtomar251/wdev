...
export class Fulltime extends React.Component {
...
render() {
    ...
    <div className="base-container" ref={this.props.containerRef}>
        <div className="header"><h2>Full Time Job</h2></div>
        <div className="content">
           ...
           <h3>APPLICATION FORM</h3>
            <div className="form">
                ...
                <div className="form-group">
                    <label htmlFor="text">Previous Experience</label>
                    <input type="text" name="previous experience"/>
                </div>
            </div>
        </div>
